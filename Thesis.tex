...
\begin{itemize}
	\item A support for a 
	
	A general advantage of proactive protocols is that
	they can give QoS guarantees related to connection set-up, latency or other real-
	time requirements. 
	
	\item Techniques to achieve fault tolerance should be developed.
	
	\item Estimation technique for Average cost and response time regaring 
	
	Average cost and response time estimation technique must be investigated and
	...
	demonstrating the advantage of data localization opportunity 
	
	\item Network delay Physical proximity affects end-to-­
	end latency, must be be considered
