...
\begin{itemize}
	...
	\item Multiple techniques to achieve fault tolerance should be investigated and developed. 
	
	For instance, when a selected concrete function is not available, instead of aborting the entire application, the model should invoke another one without violating QoS constraints.
	
	Transparency, scalability, replication management, process decoupling and traffic congestion issues must be addressed abandoning the centralized design adopted in our prototype, solving the single point of failure problem.
	...
	In addition, the adoption of machine learning techniques, like those based on deep learning, should be considered to analyze collected time series data and predict behavior or load pattern of serverless functions for function instance pre-warming or data migration.
