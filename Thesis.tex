...
To group together all points related to all serverless functions owned by an resource owner, they are stored inside directory whose name is shared with correlated user one.
...
All external libraries used to build our system are reported in table \ref{tab:libraries}. 
